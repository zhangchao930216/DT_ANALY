...
public class DateUtils {
    ...
    public static long getDateMills(String dateStr) {
    	String[] parsePatterns=new String[]{"yyyy-MM-dd HH:mm:ss","yyyy/MM/dd HH:mm:ss"};
		try {
			Date date = org.apache.commons.lang.time.DateUtils.parseDate(dateStr, parsePatterns);
	...
	public static String mills2Date(Long timeMills){
		if(timeMills!=null&&timeMills!=0l){
			Calendar c=Calendar.getInstance();
    ...
    public static String stampToDate_HH(long s){
