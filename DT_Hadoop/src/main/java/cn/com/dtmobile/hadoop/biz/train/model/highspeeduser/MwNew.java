...
public class MwNew {
	...
	public MwNew(String[] arr) {
		mwXdr = new MwXdr(arr);
		if(!arr[arr.length-2].equals("\\N")){
		...
		//		this.elong = ParseUtils.parseDouble(arr[74]);
//		this.elat = ParseUtils.parseDouble(arr[75]);
//		this.eupordown = ParseUtils.parseInteger(arr[79]);
	}
	
	@Override
	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append(mwXdr.toString());
		sb.append(etype);
	 ...
	 * @return the mwXdr
	 */
	public MwXdr getMwXdr() {
		return mwXdr;
	}
	/**
	 * @param mwXdr the mwXdr to set
	 */
	public void setMwXdr(MwXdr mwXdr) {
		this.mwXdr = mwXdr;
	}
	/**
	 * @return the gridid
