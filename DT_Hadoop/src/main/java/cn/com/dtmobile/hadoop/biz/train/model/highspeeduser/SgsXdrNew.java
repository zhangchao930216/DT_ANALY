...
public class SgsXdrNew {
	private SgsXdr sgsXdr;
	private Long gridid;
	...
	public SgsXdrNew(String [] values) {
		sgsXdr = new SgsXdr(values);
	}
	
	@Override
	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append(sgsXdr.toString());
		sb.append(etype);
	 ...
	 * @return the sgsXdr
	 */
	public SgsXdr getSgsXdr() {
		return sgsXdr;
	}
	/**
	 * @param sgsXdr the sgsXdr to set
	 */
	public void setSgsXdr(SgsXdr sgsXdr) {
		this.sgsXdr = sgsXdr;
	}
	/**
	 * @return the gridid
